...
public class Main {
	...
	public static void main(String[] args) {
		...
		MyConsumer consumerLambda = (String name) -> {
			System.out.println(name);
		};
		...
		System.out.println(predicateAnonymous.test("Sahil"));
		
		
		MyPredicate predicateLambda = (String name) -> {return name.equals("Sahil");};
		System.out.println(predicateLambda.test("Sahil"));
}
}